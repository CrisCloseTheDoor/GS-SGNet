...
def parse_sgnet_args():
    ...
    parser.add_argument('--dropout', default=0.5, type=float) # 0.5, 0.3, 0.0, 0.0, 0.0 for eth, hotel, univ, zara1, zara2
    ...
    parser.add_argument('--use_pixel_sys', action='store_true')
    parser.add_argument('--with_neighbors', action='store_true')
